...
public class MortarAndPestleMenu extends AbstractContainerMenu {
    ...
    public MortarAndPestleMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public MortarAndPestleMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(WitchyWonders.MORTAR_AND_PESTLE_MENU.get(), pContainerId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, WitchyWonders.MORTAR_AND_PESTLE.get());
    }
