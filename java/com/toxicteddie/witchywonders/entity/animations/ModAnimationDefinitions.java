...
public class ModAnimationDefinitions {
	public static final AnimationDefinition PLAYER_IDLE = AnimationDefinition.Builder.withLength(0.0F).looping()
			
		.build();

	public static final AnimationDefinition PLAYER_LAY_NORTH = AnimationDefinition.Builder.withLength(0.0F).looping()
		.addAnimation("Player", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-90.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("Player", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 2.0F, -11.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.build();

	public static final AnimationDefinition PLAYER_LAY_SOUTH = AnimationDefinition.Builder.withLength(0.0F).looping()
		.addAnimation("Player", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
	...
	public static final AnimationDefinition PLAYER_LAY_EAST = AnimationDefinition.Builder.withLength(0.0F).looping()
		.addAnimation("Player", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 90.0F, 90.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("Player", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(-11.0F, 2.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.build();

	public static final AnimationDefinition PLAYER_LAY_WEST = AnimationDefinition.Builder.withLength(0.0F).looping()
		.addAnimation("Player", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, -90.0F, -90.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("Player", new AnimationChannel(AnimationChannel.Targets.POSITION, 
