...
public class CustomPlayerModelThin<T extends Entity> extends HierarchicalModel<T> {
	...
	public CustomPlayerModelThin(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightArm = Player.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(40, 16).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(40, 32).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(-5.0F, -22.0F, 0.0F));

		PartDefinition LeftArm = Player.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(32, 48).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		//this.animateLayNorth(ModAnimationDefinitions.PLAYER_LAY_NORTH, limbSwing, limbSwingAmount, 2f, 2.5f);
		this.animate(((CustomPlayerEntityThin) entity).idleAnimationState, ModAnimationDefinitions.PLAYER_IDLE, ageInTicks, 1f);
	}
